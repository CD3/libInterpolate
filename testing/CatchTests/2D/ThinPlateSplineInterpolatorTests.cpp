...
TEST_CASE("ThinPlateSplineInterpolator Tests - Monotonic Data",
          "[thin plate spline]") {
...
TEST_CASE("ThinPlateSplineInterpolator Tests - Oscillating Data",
          "[thin plate spline]") {
    _2D::TestThinPlateSplineInterp interp;
    ...
    SECTION("Interpolation") {
        ...
        CHECK(interp(M_PI / 2, M_PI / 2) ==
              Approx(sin(M_PI / 2) * sin(M_PI / 2)).epsilon(0.02));
    }
}
